...
public class GUIMenu extends javax.swing.JFrame {
    ...
    private void ponerUsuarioLogueado() {
        ...
        if (co.unicauca.apptimarket.client.infra.Security.usuario == null) {
            this.mnuEmpleadoLogueado.setText("(Anónimo)");
        } else {
            this.mnuEmpleadoLogueado.setText("(" + co.unicauca.apptimarket.client.infra.Security.usuario.getLogin() + ")");
        }
