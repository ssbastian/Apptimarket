package co.unicauca.apptimarket.client.infra;
 ...
 */
public class ApptiMarketSocket {
    ...
    public String sendRequest(String requestJson) throws IOException {
        ...
        Logger.getLogger(ApptiMarketSocket.class.getName()).log(Level.INFO, "Lo que se le envia al: ("+requestJson+")");
        ...
        Logger.getLogger(ApptiMarketSocket.class.getName()).log(Level.INFO, "Lo que se lee del servidor: ("+response+")");
    ...
    public void disconnect() {
        ...
        try {
            ...
            Logger.getLogger(ApptiMarketSocket.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
